...
python ../semantic_uncertainty/generate_answers.py --model_name=Phi-3-mini-128k-instruct --dataset=svamp --num_samples=1000 --use_context --random_seed=20 --no-get_training_set_generations --no-compute_p_ik --no-compute_p_ik_answerable
