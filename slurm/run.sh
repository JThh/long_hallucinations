...
python ../semantic_uncertainty/generate_answers.py --model_name=Llama-2-7b-chat --temperature=1 --dataset=squad --num_samples=10000 --num_eval_samples=10000 --answerable_only
