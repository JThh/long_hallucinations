...
srun python ../semantic_uncertainty/generate_answers.py --model_name=Mistral-7B-Instruct-v0.1 --dataset=bioasq --num_samples=2000 --random_seed=20 --no-get_training_set_generations --no-compute_p_ik --no-compute_p_ik_answerable
