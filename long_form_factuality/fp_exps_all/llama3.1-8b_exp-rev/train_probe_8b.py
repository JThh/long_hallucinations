...
def run_probing(
    ...
    logger.info(f'Total Time for {classifier_name} (C={str(C_value)}, group_size={group_size}): {time_benchmarks["total_time"]:.2f} seconds')
...
def main():
    ...
    for train_file in training_files:
        ...
        for summary in probe_summaries:
            if summary['classifier_name'] == 'logistic_regression' and summary['C'] == 0.5:
