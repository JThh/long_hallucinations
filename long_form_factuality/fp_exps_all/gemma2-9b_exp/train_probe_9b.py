...
def initialize_model():
    """Initialize the tokenizer and model for Gemma2-9B."""
...
def main():
    parser = argparse.ArgumentParser(description='Probing Experiments with Logistic Regression and XGBoost for Gemma2-9B')
